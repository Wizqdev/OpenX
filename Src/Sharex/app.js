...
router.get('/dashboard', (req, res) => {
  res.render('dashboard/index.ejs', {username: req.session.user.username}); 
});

router.get('/dashboard/files', (req, res) => {
  res.render('dashboard/files.ejs', {username: req.session.user.username});
});

router.get('/dashboard/manage', async (req, res) => {

  res.render('dashboard/manage/index.ejs', {username: req.session.user.username, token: await Token.getTokens() });
});
